...
def aggregate_final_output_node(state: AgentState) -> Dict[str, Any]:
    ...
    logger.info(f"Aggregating final output: Text script, {len(retrieved_static_data)} static assets, {len(generated_visual_data)} generated assets.")
...
workflow.add_conditional_edges(
    ...
    should_continue_visuals,  # Function to decide path
    {
        ...
        "aggregate_final_output": "aggregate_final_output" # Finish visual loop, aggregate all results
    }
)
