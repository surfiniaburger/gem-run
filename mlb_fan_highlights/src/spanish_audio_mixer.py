...
class SpanishMLBAudioMixer:
    def __init__(self):
        ...
        self.background_music = {
            "intro": AudioSegment.from_mp3("assets/music/ranchero.mp3"),
            "highlight": AudioSegment.from_mp3("assets/music/highlight.mp3"),
            "outro": AudioSegment.from_mp3("assets/music/ranchero-outro.mp3")
        }
    ...
    def mix_podcast_audio(self, voice_segments: List[Dict[str, bytes]], 
        ...
        for i, segment in enumerate(voice_segments):
            ...
            triggers = self._detect_spanish_event_triggers(segment["text"])
            if triggers:
                ...
                for trigger in triggers:
                    ...
                    # Position effect for "jonrón" (home run)
                    if trigger == "crowd_cheer" and "jonrón" in segment["text"].lower():
            ...
            # Handle "momentos destacados" (highlights) background music
            if "momentos destacados" in segment["text"].lower() and include_background:
